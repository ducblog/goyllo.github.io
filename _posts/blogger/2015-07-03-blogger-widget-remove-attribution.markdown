...
<img class="img-responsive" alt="Blogger Template - Edit HTML" src="{{ site.imgurl }}/blogger-template-edit-html.png" title="Blogger Template - Edit HTML" /><br />

- Now Click to Jump to Widget and select Attribution widget like this,

<img class="img-responsive" alt="Powered by blogger attribution widget" src="{{ site.imgurl }}//blogger-attribution-widget.png" title="Powered by blogger attribution widget"/><br />
...
<img class="img-responsive" alt="Remove powered by blogger attribution widget" src="{{ site.imgurl }}/remove-powered-by-blogger-attribution-widget.png" title="Remove powered by blogger attribution widget" /><br />
